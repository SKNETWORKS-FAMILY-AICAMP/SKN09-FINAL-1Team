...
import '../css/mainpage.css';
import { Link } from 'react-router-dom';
import logoImg from '../css/wlbmate_logo.png'; // ✅ 기존 경로 기준
          ...
          <div className="left-section">
            <div className="body-section">
              ...
              >
                <div className="card-bg chat-bg"></div>
                <div className="card-img chat"></div>
                <div className="card-title">CHAT MATE</div>
              </Link>
              <Link
                to='/notemate'
                className="card"
              ...
              >
                <div className="card-bg note-bg"></div>
                <div className="card-img note"></div>
                <div className="card-title">NOTE MATE</div>
              </Link>
              <Link
                to='/querymate'
                className="card"
              ...
              >
                <div className="card-bg query-bg"></div>
                <div className="card-img query"></div>
                <div className="card-title">QUERY MATE</div>
              </Link>
              <Link
                to='/callmate'
                className="card"
              ...
              >
                <div className="card-bg call-bg"></div>
                <div className="card-img call"></div>
                <div className="card-title">CALL MATE</div>
              </Link>
            </div>
          </div>
          <div className="right-section">
                {desc === "기능을 선택하면 설명이 이곳에 표시됩니다." ? (
                  <div className="welcome-box">
                    <p className="welcome-text-top">당신의 업무를 스마트하게</p>
                    <img src={logoImg} alt="로고" className="logo-img" />
