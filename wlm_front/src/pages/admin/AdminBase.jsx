...
function AdminBase() {
    ...
    useEffect(() => {
        setUsers([
            { emp_no: 1, emp_name: "홍길동", emp_code: "A001", emp_email: "hong1@example.com", emp_birth_date: "1990-01-01", createdAt: "2024-01-01" },
            { emp_no: 2, emp_name: "김철수", emp_code: "A002", emp_email: "kim2@example.com", emp_birth_date: "1992-02-02", createdAt: "2024-01-02" },
            { emp_no: 3, emp_name: "이영희", emp_code: "A003", emp_email: "lee3@example.com", emp_birth_date: "1993-03-03", createdAt: "2024-01-03" },
            { emp_no: 4, emp_name: "박민수", emp_code: "A004", emp_email: "park4@example.com", emp_birth_date: "1994-04-04", createdAt: "2024-01-04" },
            { emp_no: 5, emp_name: "최지우", emp_code: "A005", emp_email: "choi5@example.com", emp_birth_date: "1995-05-05", createdAt: "2024-01-05" },
        ]);
    }, []);
