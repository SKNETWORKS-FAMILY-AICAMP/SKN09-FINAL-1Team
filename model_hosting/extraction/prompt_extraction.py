...
피드백: "해고 절차에 관한 고용법을 준수하지 않을 수 있으며, 회사 인사 정책에 따른 조치가 필요하며, 직원의 사정을 먼저 파악하는 것이 바람직합니다."
...
피드백: "고객 불만 사항을 무시하는 것은 소비자 보호법 위반 가능성이 있으며, 회사 정책상 모든 고객 피드백을 인정해야 하며, 고객 관계 유지를 위해 건설적인 해결 방안을 제시해야 합니다."
