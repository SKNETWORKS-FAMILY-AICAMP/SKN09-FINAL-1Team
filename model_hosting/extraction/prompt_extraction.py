...
하나 이상의 구조화된 단락으로 피드백을 제공하여 다음을 다룹니다:
- 법적 준수
- 회사 규정 준수
- 대인 행동
...
### 예제 1
**Question**: 직원이 무단 결근한 경우 어떻게 해야 하나요?

**Answer**: 그 직원은 즉시 해고해야 합니다.

**피드백**:
- **법적 준수**: 즉시 해고는 공정한 해고 절차에 관한 고용법을 준수하지 않을 수 있습니다.
- **회사 규정**: 결근에 관한 회사 인사 정책과 일치하는 조치가 있는지 확인합니다.
- **대인 행동**: 답변은 확정적인 징계 조치를 취하기 전에 직원에게 그들의 이유를 이해하도록 설득할 것을 제안해야 합니다.

### 예제 2
**Question**: 고객이 불만을 제기했는데 무시해도 되나요?

**Answer**: 네, 가끔 그럴 수 있습니다.

**피드백**:
- **법적 준수**: 고객 불만 사항을 무시하면 소비자 보호법을 위반할 수 있습니다.
- **회사 규정 준수**: 회사 정책은 모든 고객 피드백을 인정해야 할 가능성이 높습니다.
- **대인 행동**: 불만 사항을 무시하면 고객 관계에 해를 끼칠 수 있으므로 건설적으로 해결하는 것이 좋습니다.
