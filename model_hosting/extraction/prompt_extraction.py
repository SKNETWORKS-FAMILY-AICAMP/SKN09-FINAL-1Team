...
답변은 반드시 한국어로 작성하세요. 중국어는 절대 사용하지 마세요.
...
1. **질문과 답변 분석**: 질문과 답변 모두에서 제공되는 맥락과 내용을 이해합니다.
2. **법적 준수 평가**: 답변이 관련 법적 원칙을 따르는지 확인합니다.
3. **회사 규정 준수 평가**: 응답이 회사별 지침과 일치하는지 확인합니다.
4. **대인 행동 검토**: 질문자를 대하는 데 있어 답변이 존중과 적절성을 보여주는지 평가합니다.
5. **구성 피드백**: 강점과 개선할 부분을 강조하는 명확하고 건설적인 피드백을 제공합니다.

# 출력 형식

각 Q&A 쌍에 대해 하나의 문장으로 피드백을 제공하되, 다음 세 가지 측면을 모두 포함해야 합니다:
- 법적 준수 여부
- 회사 규정 준수 여부
- 대인 행동의 적절성

중요: 피드백만 작성하고, 질문과 답변은 절대 포함하지 마세요.
각 피드백은 새로운 줄에 작성하되, 질문과 답변을 반복하지 마세요.

# 예시

### 예제 1
질문: 직원이 무단 결근한 경우 어떻게 해야 하나요?
답변: 그 직원은 즉시 해고해야 합니다.

피드백:
해고 절차에 관한 고용법을 준수하지 않을 수 있으며, 회사 인사 정책에 따른 조치가 필요하며, 직원의 사정을 먼저 파악하는 것이 바람직합니다.

### 예제 2
질문: 고객이 불만을 제기했는데 무시해도 되나요?
답변: 네, 가끔 그럴 수 있습니다.

피드백:
고객 불만 사항을 무시하는 것은 소비자 보호법 위반 가능성이 있으며, 회사 정책상 모든 고객 피드백을 인정해야 하며, 고객 관계 유지를 위해 건설적인 해결 방안을 제시해야 합니다.

# 노트
- 특정 법적 예외나 고유한 회사 정책과 같이 피드백에 더 많은 맥락이 영향을 미칠 수 있는 엣지 케이스를 고려해 보세요.
- 각 Q&A 쌍에 대해 개별적인 피드백을 제공하되, 전체적인 맥락에서의 일관성도 고려하세요.
- 피드백은 반드시 하나의 문장으로 작성하되, 법적/규정/대인 관계 측면을 모두 포함해야 합니다.
- 피드백만 작성하고, 질문과 답변은 절대 포함하지 마세요.

# 출력 예시
- Q&A1에 대한 피드백: 해고 절차에 관한 고용법을 준수하지 않을 수 있으며, 회사 인사 정책에 따른 조치가 필요하며, 직원의 사정을 먼저 파악하는 것이 바람직합니다.
- Q&A2에 대한 피드백: 고객 불만 사항을 무시하는 것은 소비자 보호법 위반 가능성이 있으며, 회사 정책상 모든 고객 피드백을 인정해야 하며, 고객 관계 유지를 위해 건설적인 해결 방안을 제시해야 합니다.
"""
