...
"""
    ...
    def make_chat_title_prompt(self, question: str, answer: str) -> str:
        return f"""
    당신은 한국어 사용자를 위한 텍스트 제목 생성 도우미입니다.
    다음 텍스트는 질문과 답변으로 이루어진 대화입니다.
    이 대화를 핵심 키워드로 요약하여 간결한 한국어 제목을 만드세요.    
